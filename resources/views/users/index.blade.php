...
@if(session('userUpdated'))
    <div class="alert alert-success d-flex align-items-center" role="alert">
        ...
        <div><strong>{{session('userUpdated')}}</strong></div>
    </div><br>
@endif
@if(session('userDeleted'))
    <div class="alert alert-success d-flex align-items-center" role="alert">
        ...
        <div><strong>{{session('userDeleted')}}</strong></div>
    </div><br>
@endif
    ...
    <div class="col-md-12">
        <div class="card-header">Manage Users
            <div class="btn-actions-pane-right">
                <a href="{{route('users.export_excel')}}" class="btn btn-outline-dark">Excel</a>
                <a href="{{route('users.export_csv')}}" class="btn btn-outline-dark">CSV</a>
                ...
                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th rowspan="1" colspan="1" class="text-center">Profile</th>
                            ...
                            <th rowspan="1" colspan="1" class="text-center">PinCode</th>
